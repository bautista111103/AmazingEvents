  ...
  <header>
          ...
          <div class="container-fluid">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="navbarOffcanvasLg" aria-labelledby="navbarOffcanvasLgLabel">
              <div class="navbar-nav">
                ...
                <a class="a-header" href="../html/past-events.php">Past Events</a>
    ...
    <main>
      <div class="contenedor-boton">
        <div>
          <a href="../html/upcoming-events.html"><img class="boton" src="../assets/Images/boton-izquierdo.png" alt=""></a>
        </div>
        <div>
          <p>Contact</p>
        </div>
        <div>
          <a href="../html/stats.html"><img class="boton" src="../assets/Images/boton-derecho.png" alt=""></a>
        </div>
      </div>
          <div class="f-contact">
            <form action="../show_data.html">
              <fieldset>
                <legend>Name:</legend>
                  <label>
                  <input class="input-c" type="text" name="name" id="name">
                  </label>
              </fieldset>
              <fieldset>
                <legend>Email:</legend>
                <label>
                  <input class="input-c" type="text" name="email" id="email">
                </label>
              </fieldset>
              <fieldset>
                <legend>Mensagge:</legend>
                <label>
                  <input class="input-m" type="text" name="Mensagge" id="Mensagge">
                </label>
              </fieldset>
              <input class="boton-enviar" type="submit" name="submit">
          </form>
          </div>
    </main>
    <footer>
