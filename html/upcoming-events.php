  ...
  <header>
         ...
         <div class="container-fluid">
           ...
           <div class="offcanvas offcanvas-end" tabindex="-1" id="navbarOffcanvasLg" aria-labelledby="navbarOffcanvasLgLabel">
             <div class="navbar-nav">
               ...
               <a class="a-header" href="#">Upcoming Events</a>
    ...
    <main>
      <div class="contenedor-boton">
        <div>
          <a href="../html/past-events.html"><img class="boton" src="../assets/Images/boton-izquierdo.png" alt=""></a>
        </div>
        <div>
          <p>Upcoming Events</p>
        </div>
        <div>
          <a href="../html/contact.html"><img class="boton" src="../assets/Images/boton-derecho.png" alt=""></a>
        </div>
      </div>
